...
export default function AdminCommentsPage() {
  ...
  const [commentToDeleteId, setCommentToDeleteId] = useState<string | null>(null); // State to store comment ID for deletion
  ...
  const fetchComments = useCallback(async (page: number, search: string = '') => {
    try {
      ...
      setComments(response); // Access results property
