      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-justify text-gray-800 dark:text-gray-200">
          ...
          <p>
            ...
            post on or through the Site, including its legality, reliability,
            and appropriateness.
          </p>
          <p>
            By posting Content on or through the Site, you represent and warrant
            that: (i) the Content is yours and/or you have the right to use it
            and grant us the rights and license as provided in these Terms, and
            (ii) the posting of your Content on or through the Site does not
          ...
          <p>
            ...
            access the Site and for any activities or actions under your
