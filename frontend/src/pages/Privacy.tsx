  ...
  return <div className="py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-justify text-gray-800 dark:text-gray-200">
          ...
          <h3 className="text-gray-900 dark:text-gray-100">Personal Data</h3>
          <p>
            When you register an account to comment on our articles, we collect
            your name and email address. This information is used to identify
            you as a commenter and to communicate with you if necessary.
          </p>
          <h3 className="text-gray-900 dark:text-gray-100">Derivative Data</h3>
          <p>
          ...
          <h3 className="text-gray-900 dark:text-gray-100">Cookies and Web Beacons</h3>
          <p>
            We may use cookies, web beacons, tracking pixels, and other tracking
            technologies to help customize the website and improve your
            experience. You can instruct your browser to refuse all cookies or
            to indicate when a cookie is being sent.
          </p>
          <h2 className="text-gray-900 dark:text-gray-100">Use of Your Information</h2>
          <p>
          ...
          <ul>
            ...
            <li>Protect the website, our users, and our business</li>
          </ul>
          <h2 className="text-gray-900 dark:text-gray-100">Disclosure of Your Information</h2>
          <p>
            We may share information we have collected about you in certain
            situations. Your information may be disclosed as follows:
          </p>
          <h3 className="text-gray-900 dark:text-gray-100">By Law or to Protect Rights</h3>
          <p>
          ...
          <h3 className="text-gray-900 dark:text-gray-100">Third-Party Service Providers</h3>
          <p>
            We may share your information with third parties that perform
            services for us or on our behalf, including data analysis, email
            delivery, hosting services, and customer service.
          </p>
          <h2 className="text-gray-900 dark:text-gray-100">Security of Your Information</h2>
          <p>
          ...
          <p>
            ...
            contact us at privacy@el-deras-writes.com.
          </p>
        </div>
      </div>
    </div>;
