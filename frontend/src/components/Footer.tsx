        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {contactInfo?.medium_link && (
                <a href={contactInfo.medium_link} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900" aria-label="Medium">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {contactInfo?.github_link && (
                <a href={contactInfo.github_link} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900" aria-label="GitHub">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
